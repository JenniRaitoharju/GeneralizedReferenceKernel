...
addpath('C:\Users\Alekos Iosifidis\Desktop\OC-ELM_experiments\methods\prtools');
addpath('C:\Users\Alekos Iosifidis\Desktop\OC-ELM_experiments\methods\dd_tools');

a = target_class(gendatb([40 40]),'1');

% a = [rand(2,100) 100+rand(2,100)]';
% 
% w_kpca = kwhiten(a,0.999,'radial_basis',10,[]);
% AAA = +w_kpca;
% 
% data = +a';
% [Ktrain, Ktest] = kernel_rbf(data, data, 0, data, 10);
% Ktrain2 = AAA.Korg;     Diff = Ktrain - Ktrain2;
% 
% projData = AAA.alf' * Ktrain;
% [Ktrain3, Ktest] = kernel_rbf(projData, projData, 0, projData, 10);
% Diff2 = Ktrain3 - Ktrain2;
